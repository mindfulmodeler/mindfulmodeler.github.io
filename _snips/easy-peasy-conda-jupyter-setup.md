...
One place I find conda environments to be extremely useful is when working with the package **Django** to [create dynamic web applications]({{site.baseurl}}/tutorial/django-infectious-disease-app/). I always start with a fresh conda environment for Django apps and it's simple to switch between environments when I need to.
