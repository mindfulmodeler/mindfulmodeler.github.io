...
![merged shapefile geodataframe]({{site.baseurl}}/images/mvlg-merged-gdf-head.jpg)
...
![merged cleaned subset geodataframe]({{site.baseurl}}/images/mvlg-merged-cleaned-gdf-head.jpg)
...
def create_feature_map(gdf, feature_name, feature_min=0, feature_max=100, color_style="Greys", save=False):
    ...
    save: pass True to save as .jpg file (default: False)
    """
    ...
    if save == True:
        fig.savefig("Map_{}.jpg".format(feature_name), dpi=300)
{% endhighlight %}
...
![map ugandan poverty rate python]({{site.baseurl}}/images/Map_PovertyRate.jpg)
...
![map ugandan improved sanitation access]({{site.baseurl}}/images/Map_HHs_wSanAccess.jpg)
...
![seaborn pairplot visual]({{site.baseurl}}/images/mvlg-pairplot.jpg)
...
![histogram household sanitation access]({{site.baseurl}}/images/mvlg-san-access-histogram.jpg)
...
![histogram GINI index Uganda]({{site.baseurl}}/images/mvlg-gini-histogram.jpg)
...
![multivariate regression prediction]({{site.baseurl}}/images/mvlg-step5.jpg)
...
![multivariate correlation](../assets/img/mvlg-correlation.jpg){:.post-img-smaller} -->
...
![multivariate regression multicollinearity]({{site.baseurl}}/images/mvlg-multicollinearity.jpg)
