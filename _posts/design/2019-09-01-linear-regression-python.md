...
![Linear relationship check]({{site.baseurl}}/images/births_vs_lifeexp.png)
...
![Linear relationship join plot]({{site.baseurl}}/images/linear_reg_join_plot.png)
...
![actual vs predicted regression]({{site.baseurl}}/images/lin_pred_actual_barchart.png)
...
![linear model scatter]({{site.baseurl}}/images/lin_model_scatter.png)
