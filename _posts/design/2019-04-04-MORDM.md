...
categories:
    - modeling
header:
    image_fullwidth: "/aposteriori.webp"
show_meta: true
comments: true
---
...
![a posteriori decision analysis]({{site.baseurl}}/images/aposteriori.webp)
...
![MORDM search steps]({{site.baseurl}}/images/mordm-img.webp)
...
![XLRM example]({{site.baseurl}}/images/xlrm-example1.webp)
