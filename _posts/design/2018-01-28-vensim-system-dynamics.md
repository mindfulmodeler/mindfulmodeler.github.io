...
![vensim software system dynamics]({{site.baseurl}}/images/vensim.webp)
...
![32-bit versus 64-bit processor]({{site.baseurl}}/images/processor-32-vs-64.webp)
...
![conda environment python]({{site.baseurl}}/images/conda-env.webp)
